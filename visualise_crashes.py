...
crashes = pd.read_csv('dataset/Crashes/crash_info_general.csv', usecols=['CRN', 'DEC_LAT', 'DEC_LONG'])
...
merged_df = merged_df.query('DVR_PED_CONDITION == 1').query('PERSON_TYPE == 1').reset_index(drop=True)
